...
use TwoCheckout\Events\OrderCreated;
...
class OrderCreatedTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->event = new OrderCreated($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('ORDER_CREATED',$event->type());
