...
use TwoCheckout\Events\RecurringRestarted;

class RecurringRestartedTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new RecurringRestarted($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('RECURRING_RESTARTED',$event->type());
