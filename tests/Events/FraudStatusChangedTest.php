...
use TwoCheckout\Events\FraudStatusChanged;

class FraudStatusChangedTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new FraudStatusChanged($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('FRAUD_STATUS_CHANGED',$event->type());
