...
use TwoCheckout\Events\RecurringStopped;

class RecurringStoppedTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new RecurringStopped($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('RECURRING_STOPPED',$event->type());
