...
use TwoCheckout\Events\RecurringComplete;

class RecurringCompleteTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new RecurringComplete($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('RECURRING_COMPLETE',$event->type());
