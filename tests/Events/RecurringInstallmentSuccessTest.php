...
use TwoCheckout\Events\RecurringInstallmentSuccess;

class RecurringInstallmentSuccessTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new RecurringInstallmentSuccess($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('RECURRING_INSTALLMENT_SUCCESS',$event->type());
