...
use TwoCheckout\Events\ShipStatusChanged;

class ShipStatusChangedTest extends TestCase
{
    public function setUp()
    {
        $secret_word = 'tHeBroWnFoXjUmpSoVerTheLazyDoG';
        $this->event = new ShipStatusChanged($secret_word);
    }
    ...
    public function testListenToValidEvent($event)
    {
        ...
        $this->assertEquals('SHIP_STATUS_CHANGED',$event->type());
